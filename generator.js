...
(function (global) {
  ...
  function blockMerfolk(o) {
    ...
    return {
      short: ['single fish tail', 'no human legs', 'no feet'],
      detailed: ['with the lower body ending in a single scaled mermaid tail, replacing separate human legs and feet']
    };
  }
