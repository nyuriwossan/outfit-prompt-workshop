...
(function (global) {
  ...
  CPW.data.decorations = [
    ...
    /* ---- Phase 5B 前半：追加装飾（35件） ---- */
    { id: 'ruffles', uncountable: true, prep: 'along', labelJa: 'ラッフル', shortPrompt: 'ruffles', detailedPrompt: 'layered ruffles', tags: ['frilled'], weight: 2, recommendedAttributes: ['wind'], recommendedPlacements: ['hem', 'sleeves', 'skirt'] },
    { id: 'frills', uncountable: true, prep: 'along', labelJa: 'フリル', shortPrompt: 'frills', detailedPrompt: 'delicate frills', tags: ['frilled'], weight: 1, recommendedAttributes: ['wind', 'light'], recommendedPlacements: ['collar', 'cuffs', 'hem'] },
    { id: 'piping', uncountable: true, prep: 'along', labelJa: 'パイピング', shortPrompt: 'piping', detailedPrompt: 'contrast piping', tags: ['plain', 'structured'], weight: 1, recommendedAttributes: [], recommendedPlacements: ['collar', 'cuffs', 'hem'] },
    { id: 'braided_trim', uncountable: true, prep: 'along', labelJa: '組紐飾り', shortPrompt: 'braided trim', detailedPrompt: 'woven braided trim', tags: ['ornate'], weight: 1, recommendedAttributes: ['earth'], recommendedPlacements: ['collar', 'cuffs', 'cape_edges'] },
    { id: 'tassels', prep: 'at', labelJa: 'タッセル', shortPrompt: 'tassels', detailedPrompt: 'swaying tassels', tags: ['ornate'], weight: 2, recommendedAttributes: ['wind'], recommendedPlacements: ['waist', 'hem', 'shoulders'] },
    { id: 'pom_poms', prep: 'at', labelJa: 'ポンポン', shortPrompt: 'pom-poms', detailedPrompt: 'fluffy pom-poms', tags: ['soft', 'playful'], weight: 2, recommendedAttributes: ['light'], recommendedPlacements: ['hem', 'head', 'chest'] },
    { id: 'fur_trim', uncountable: true, prep: 'around', labelJa: 'ファー縁取り', shortPrompt: 'fur trim', detailedPrompt: 'plush fur trim', tags: ['fluffy', 'warm'], weight: 2, recommendedAttributes: ['ice', 'wind'], recommendedPlacements: ['collar', 'cuffs', 'hem'] },
    { id: 'sequins', uncountable: true, prep: 'on', labelJa: 'スパンコール', shortPrompt: 'sequins', detailedPrompt: 'shimmering sequins', tags: ['sparkling'], weight: 2, recommendedAttributes: ['light', 'thunder'], recommendedPlacements: ['chest', 'skirt', 'overall'] },
    { id: 'rhinestones', uncountable: true, prep: 'on', labelJa: 'ラインストーン', shortPrompt: 'rhinestones', detailedPrompt: 'glittering rhinestones', tags: ['sparkling'], weight: 2, recommendedAttributes: ['light'], recommendedPlacements: ['chest', 'cuffs', 'overall'] },
    { id: 'beadwork', uncountable: true, prep: 'along', labelJa: 'ビーズ刺繍', shortPrompt: 'beadwork', detailedPrompt: 'intricate beadwork', tags: ['ornate'], weight: 2, recommendedAttributes: ['light', 'water'], recommendedPlacements: ['chest', 'collar', 'hem'] },
    { id: 'gem_settings', prep: 'at', labelJa: '宝石の飾り座', shortPrompt: 'gem settings', detailedPrompt: 'set gemstones', tags: ['jewel', 'ornate'], weight: 3, recommendedAttributes: ['light'], recommendedPlacements: ['chest', 'waist', 'head'] },
    { id: 'decorative_buttons', prep: 'along', labelJa: '飾りボタン', shortPrompt: 'decorative buttons', detailedPrompt: 'ornamental buttons', tags: ['classic'], weight: 1, recommendedAttributes: [], recommendedPlacements: ['chest', 'cuffs'] },
    { id: 'brass_buttons', prep: 'along', labelJa: '真鍮ボタン', shortPrompt: 'brass buttons', detailedPrompt: 'polished brass buttons', tags: ['metallic', 'military'], weight: 1, recommendedAttributes: ['earth', 'fire'], recommendedPlacements: ['chest', 'cuffs'] },
    { id: 'buckles', prep: 'at', labelJa: 'バックル', shortPrompt: 'buckles', detailedPrompt: 'sturdy buckles', tags: ['functional', 'rough'], weight: 1, recommendedAttributes: ['earth'], recommendedPlacements: ['waist', 'chest', 'legs'] },
    { id: 'zippers', prep: 'along', labelJa: 'ジッパー飾り', shortPrompt: 'zipper details', detailedPrompt: 'exposed zipper details', tags: ['functional', 'modern'], weight: 1, recommendedAttributes: ['thunder'], recommendedPlacements: ['chest', 'sleeves', 'legs'] },
    { id: 'epaulette_ornaments', prep: 'on', labelJa: '飾り肩章', shortPrompt: 'ornamental epaulettes', detailedPrompt: 'fringed ornamental epaulettes', tags: ['military', 'ornate'], weight: 2, recommendedAttributes: ['fire'], recommendedPlacements: ['shoulders'] },
    { id: 'aiguillettes', prep: 'at', labelJa: '飾緒', shortPrompt: 'aiguillettes', detailedPrompt: 'braided aiguillettes', tags: ['military', 'ornate'], weight: 2, recommendedAttributes: ['light'], recommendedPlacements: ['shoulders', 'chest'] },
    { id: 'medals', prep: 'on', labelJa: '勲章', shortPrompt: 'medals', detailedPrompt: 'ceremonial medals', tags: ['military', 'ornate'], weight: 2, recommendedAttributes: ['light'], recommendedPlacements: ['chest'] },
    { id: 'generic_badges', prep: 'on', labelJa: '記章', shortPrompt: 'badges', detailedPrompt: 'generic badges', tags: ['uniform'], weight: 1, recommendedAttributes: [], recommendedPlacements: ['chest', 'shoulders'] },
    { id: 'fictional_insignia', prep: 'on', labelJa: '架空の徽章', shortPrompt: 'fictional insignia', detailedPrompt: 'fictional organization insignia', tags: ['uniform'], weight: 1, recommendedAttributes: [], recommendedPlacements: ['chest', 'shoulders'] },
    { id: 'frog_closures', prep: 'along', labelJa: 'フロッグ留め', shortPrompt: 'frog closures', detailedPrompt: 'ornamental frog closures', tags: ['chinese', 'classic'], weight: 1, recommendedAttributes: [], recommendedPlacements: ['chest', 'collar'] },
    { id: 'knot_buttons', prep: 'along', labelJa: 'チャイナ結びボタン', shortPrompt: 'knot buttons', detailedPrompt: 'hand-knotted buttons', tags: ['chinese'], weight: 1, recommendedAttributes: [], recommendedPlacements: ['chest', 'collar'] },
    { id: 'lace_panels', prep: 'at', labelJa: 'レースパネル', shortPrompt: 'lace panels', detailedPrompt: 'inset lace panels', tags: ['frilled', 'sheer_panel'], weight: 2, recommendedAttributes: ['light'], recommendedPlacements: ['chest', 'back', 'skirt'] },
    { id: 'mesh_panels', prep: 'at', labelJa: 'メッシュパネル', shortPrompt: 'mesh panels', detailedPrompt: 'inset mesh panels', tags: ['sheer_panel', 'modern'], weight: 2, recommendedAttributes: ['wind'], recommendedPlacements: ['chest', 'back', 'sleeves'] },
    { id: 'ribbon_lacing', uncountable: true, prep: 'along', labelJa: 'リボン編み上げ', shortPrompt: 'ribbon lacing', detailedPrompt: 'criss-cross ribbon lacing', tags: ['frilled'], weight: 2, recommendedAttributes: [], recommendedPlacements: ['chest', 'back', 'sleeves'] },
    { id: 'corset_lacing', uncountable: true, prep: 'along', labelJa: 'コルセット編み上げ', shortPrompt: 'corset lacing', detailedPrompt: 'structured corset lacing', tags: ['structured'], weight: 2, recommendedAttributes: ['darkness'], recommendedPlacements: ['waist', 'back', 'chest'] },
    { id: 'chain_details', uncountable: true, prep: 'along', labelJa: '鎖の意匠', shortPrompt: 'chain details', detailedPrompt: 'fine chain details', tags: ['metallic'], weight: 2, recommendedAttributes: ['thunder', 'darkness'], recommendedPlacements: ['waist', 'chest', 'legs'] },
    { id: 'feather_trim', uncountable: true, prep: 'around', labelJa: '羽根縁取り', shortPrompt: 'feather trim', detailedPrompt: 'soft feather trim', tags: ['soft'], weight: 2, recommendedAttributes: ['wind', 'light'], recommendedPlacements: ['collar', 'hem', 'cape_edges'] },
    { id: 'bell_ornaments', prep: 'at', labelJa: '鈴飾り', shortPrompt: 'bell ornaments', detailedPrompt: 'small bell ornaments', tags: ['playful'], weight: 1, recommendedAttributes: ['wind'], recommendedPlacements: ['waist', 'head', 'hem'] },
    { id: 'heart_charms', prep: 'at', labelJa: 'ハートチャーム', shortPrompt: 'heart charms', detailedPrompt: 'dangling heart charms', tags: ['sweet'], weight: 1, recommendedAttributes: ['light'], recommendedPlacements: ['chest', 'waist', 'head'] },
    { id: 'moon_charms', prep: 'at', labelJa: '月チャーム', shortPrompt: 'moon charms', detailedPrompt: 'crescent moon charms', tags: ['celestial'], weight: 1, recommendedAttributes: ['darkness', 'light'], recommendedPlacements: ['chest', 'head', 'waist'] },
    { id: 'star_charms', prep: 'at', labelJa: '星チャーム', shortPrompt: 'star charms', detailedPrompt: 'tiny star charms', tags: ['celestial'], weight: 1, recommendedAttributes: ['light'], recommendedPlacements: ['chest', 'head', 'hem'] },
    { id: 'shell_ornaments', prep: 'at', labelJa: '貝殻飾り', shortPrompt: 'shell ornaments', detailedPrompt: 'polished shell ornaments', tags: ['oceanic'], weight: 2, recommendedAttributes: ['water'], recommendedPlacements: ['chest', 'head', 'waist'] },
    { id: 'coral_ornaments', prep: 'at', labelJa: '珊瑚飾り', shortPrompt: 'coral ornaments', detailedPrompt: 'branching coral ornaments', tags: ['oceanic'], weight: 2, recommendedAttributes: ['water', 'nature'], recommendedPlacements: ['head', 'chest'] },
    { id: 'gear_ornaments', prep: 'at', labelJa: '歯車飾り', shortPrompt: 'gear ornaments', detailedPrompt: 'interlocking gear ornaments', tags: ['mechanical', 'steampunk'], weight: 2, recommendedAttributes: ['thunder', 'earth'], recommendedPlacements: ['chest', 'waist', 'shoulders'] },
    { id: 'clockwork_details', uncountable: true, prep: 'along', labelJa: '時計仕掛けの意匠', shortPrompt: 'clockwork details', detailedPrompt: 'exposed clockwork details', tags: ['mechanical', 'steampunk'], weight: 2, recommendedAttributes: ['thunder'], recommendedPlacements: ['chest', 'sleeves', 'waist'] }
  ];
